...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        and postorder.
        All three of these traversals are implemented for you as a reference on
        how to write recursive functions on recursive data structures.
        '''
    ...
    def to_list(self, traversal_type):
        ...
        if traversal_type == 'postorder':
            ...
            raise ValueError("traversal type entered is invalid")
    ...
    def __len__(self):
        ...
        '''
        ret = BinaryTree.__len__helper(self.root)
        return ret
    ...
    def __len__helper(node):
        ...
        leng = 1
        if node.left:
            leng += BinaryTree.__len__helper(node.left)
        if node.right:
            leng += BinaryTree.__len__helper(node.right)
        return leng
    ...
    def height(self):
        ...
        '''
        ret = BinaryTree._height(self.root)
        return ret
